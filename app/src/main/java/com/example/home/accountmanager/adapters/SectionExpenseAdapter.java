...
public class SectionExpenseAdapter extends SectionCursorAdapter {
    ...
    protected void bindItemView(View convertView, Context context, Cursor cursor) {
        ...
        TextView tvExpenseValue = convertView.findViewById(R.id.expense_value_text_view);
        TextView tvExpenseCurrency = convertView.findViewById(R.id.expense_currency_text_view);
        TextView tvExpenseCatName = convertView.findViewById(R.id.expense_category_name_text_view);
