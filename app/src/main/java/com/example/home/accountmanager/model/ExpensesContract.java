package com.example.home.accountmanager.model;
...
public class ExpensesContract {
    /**
     * The authority for the expenses model
     */
    public static final String AUTHORITY = "com.example.home.accountmanager.provider";
    /**
    ...
    public static class Categories implements BaseColumns, CategoriesColumns {
        ...
        public static final String CONTENT_TYPE =
                "vnd.android.cursor.dir/vnd.home.accountmanager.provider.expense_category";

        /**
         * The MIME type of a {@link #CONTENT_URI} sub-directory of a single category.
         */
        public static final String CONTENT_ITEM_TYPE =
                "vnd.android.cursor.item/vnd.home.accountmanager.provider.expense_category";
    ...
    public static class Expenses implements BaseColumns, ExpensesColumns {
         ...
         */
        public static final String CONTENT_TYPE =
                "vnd.android.cursor.dir/vnd.home.accountmanager.provider.expense";

        /**
         * The MIME type of a {@link #CONTENT_URI} sub-directory of a single expense.
         */
        public static final String CONTENT_ITEM_TYPE =
                "vnd.android.cursor.item/vnd.home.accountmanager.provider.expense";
    ...
    public static class ExpensesWithCategories implements BaseColumns {
         ...
         */
        public static final String CONTENT_TYPE =
                "vnd.android.cursor.dir/vnd.home.accountmanager.provider.expense_with_category";
